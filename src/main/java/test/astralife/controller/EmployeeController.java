...
import test.astralife.repository.EmployeeRepository;
...
public class EmployeeController {
	...
	public ResponseEntity<Employee> updateEmployee(@PathVariable(value = "id") Long employeeId,
		...
		employee.setLastPosition(employeeDetails.getType());
		employee.setPositionId(employeeDetails.getPositionId());
		employee.setDivisionId(employeeDetails.getDivisionId());
